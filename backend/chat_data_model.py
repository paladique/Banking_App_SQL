...
def init_chat_db(database):
    ...
    global db, ChatHistory, ChatSession, ToolUsage, ToolDefinition, ChatHistoryManager
    db = database
    ...
    # --- Chat History and Tool Usage Models ---
...
def clear_chat_history():
    ...
    try:
        ...
        deleted_tool_usage = ToolUsage.query.delete()
        deleted_chat_history = ChatHistory.query.delete()
        deleted_chat_sessions = ChatSession.query.delete()
